...
def encrypt(in_block, key, verbose=False):
...
def decrypt(out_block, key, verbose=False):
...
if __name__ == '__main__':
    ...
    print("my ciphertext : ", encrypt(test_block, test_key))
    print("decrypted ciphertext:", decrypt(ciphertext, test_key))
